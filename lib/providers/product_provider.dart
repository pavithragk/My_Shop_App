...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSave([bool filterByUser = false]) async {
    ...
    final url =
        'https://myshopapp-82049.firebaseio.com/products.json?auth=$authToken&$filterString';
    try {
  ...
  Future<void> addProduct(Product product) async {
    final url =
        'https://myshopapp-82049.firebaseio.com/products.json?auth=$authToken';
    try {
  ...
  void updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          'https://myshopapp-82049.firebaseio.com/products/$id.json?auth=$authToken';
